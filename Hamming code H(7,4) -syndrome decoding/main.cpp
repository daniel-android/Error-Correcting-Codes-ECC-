...
#include "PCMDecodingForH(7,4).h" //call the header with the decoder of the Hamming Code H(7,4)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   if (newfile.is_open()){ //checking whether the file is open
      ...
      while(getline(newfile, tp)){ //read data from file object and put it into string tp.
         ...
         //Decoding: Parity-check matrix method (syndrome)------------------------------------------------  
         PCMDecoding(ptr,ptrDecMessage);
